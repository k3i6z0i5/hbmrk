  ...
  return (
    <aside className="sidebar" id="sidebar">
      ...
      <div className="sidebar-card cta-card">
        <Link href="/publish?tab=submission" className="sidebar-cta-btn">
      ...
      <div className="sidebar-card">
        ...
        <ul className="sidebar-links">
          <li><Link href="/publish?tab=guidelines">For Authors</Link></li>
          <li><Link href="/publish?tab=peer-review">For Reviewers</Link></li>
          <li><Link href="/about?tab=open-access">Open Access Policy</Link></li>
        </ul>
      </div>
