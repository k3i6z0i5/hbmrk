    ...
    return (
      <Layout sidebar={<Sidebar />} breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Journals', path: '/current-issue' }]}>
        <div className="current-issue-page" style={{ textAlign: 'center', padding: '3rem' }}>
          ...
          <h3>Loading Journals & Articles...</h3>
        </div>
      </Layout>
    )
  }
    ...
    <Layout sidebar={<Sidebar />} breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Journals', path: '/current-issue' }]}>
      <div className="current-issue-page animate-fade-in">
        <div className="current-issue-header">
          <h1 className="page-main-title">Published Journals</h1>
        ...
        <p className="archives-intro-text" style={{ marginBottom: 'var(--space-lg)' }}>
          Browse our research publications organized by their topics or search for articles by their authors.
        </p>
