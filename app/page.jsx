      ...
      <section className="hero" id="hero-section">
        ...
        <div className="container hero-content">
          ...
          <div className="hero-actions animate-fade-in-up stagger-3">
            <Link href="/publish?tab=submission" className="btn btn-gold">
            ...
            <Link href="/current-issue" className="btn btn-outline-white">
              Journals
            </Link>
          </div>
        </div>
      ...
      <Layout sidebar={<Sidebar />} breadcrumbs={[{ label: 'Home', path: '/' }]}>
        ...
        <section className="content-section" id="call-for-papers">
          ...
          <div className="cfp-banner">
            ...
            <div>
              <h3>Submissions Open for Research Publications</h3>
              <p style={{marginBottom: 0}}>We invite high-quality submissions for our upcoming journal editions.</p>
            </div>
          </div>
          <div className="content-text">
            <p>The <strong>Hallmark Business and Management Review (HBMR)</strong>, a biannual, peer-reviewed, double-blind online journal published by Hallmark Business School, Thanjavur, Tamil Nadu, invites high-quality submissions for publication.</p>
          ...
          <div className="submission-info-box">
            ...
            <Link href="/publish?tab=submission" className="btn btn-primary">
