        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/about?tab=aim">Aim & Scope</Link></li>
              <li><Link to="/editorial-board">Editorial Board</Link></li>
              <li><Link to="/about?tab=advisory">Advisory Board</Link></li>
              <li><Link to="/publish">Author Guidelines</Link></li>
              <li><Link to="/about?tab=privacy">Privacy Statement</Link></li>
